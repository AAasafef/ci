    ...
    return GlassCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Track shifts, pay, goals, tasks, certifications, coworkers, schedules, and career growth.',
            style: TextStyle(
                ...
                Expanded(
                  child: ListView(
                    children: [
                      ...
                      const SizedBox(height: 10),
                      const Text(
                        'Career structure without chaos.',
                        style: TextStyle(
                      ...
                      _workCard(
                        ...
                        title: 'Schedule',
                        subtitle: 'Track shifts, workdays, time off, and availability.',
                        stat: '5',
                      ),
                      ...
                      _workCard(
                        ...
                        title: 'Pay & Hours',
                        subtitle: 'Track hours worked, expected pay, overtime, and deposits.',
                        stat: '\$',
                      ),
                      const SizedBox(height: 14),
                      _workCard(
                        ...
                        subtitle: 'Licenses, renewals, CEUs, nursing school, and career documents.',
                        stat: '3',
                      ),
                      const SizedBox(height: 14),
                      _workCard(
                        ...
                        title: 'Career Goals',
                        subtitle: 'Promotions, applications, resumes, interviews, and growth plans.',
                        stat: '8',
                      ),
